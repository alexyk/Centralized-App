      ...
      <div>
        <section className="details-view" id="details">
          ...
          <div className="static-map-container">
            <img className="static-map-address" src={`https://maps.googleapis.com/maps/api/staticmap?center=${bookingData.latitude},${bookingData.longitude}&zoom=13&size=640x480&markers=${bookingData.latitude},${bookingData.longitude}&key=AIzaSyChkMMG4T3hm2JyHHskUDCqLZWf9svbPGU`} alt="static-map-address" />
          </div>
