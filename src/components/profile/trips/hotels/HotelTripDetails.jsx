  ...
  renderHotelStars(starsCount) {
    ...
    for (let i = 0; i < maxCountOfStars; i++) {
      if (i < hotelStarsCount) {
        ...
        stars.push(
          <img className="star-image" src={Star} key={`star-${i}`} alt="star" />
        );
      }
    }
    ...
    if (safeChargeMode === "success") {
      return (
        <section className="details-view safecharge-success" id="details">
          ...
          <p>
            Your reservation has been initiated to the hotel and is pending
            confirmation.{" "}
          </p>
          <p>
            Confirmation usually takes few minutes but in some rare occasions
            could take up to several hours.
          </p>
          <p>
            You can monitor the status of your booking in your Dashboard under{" "}
            <Link to="/profile/trips/hotels">My Trips</Link> tab.
          </p>
          <p>
            As soon as the booking is confirmed by the hotel, we will
            immediately notify you via email.
          </p>
          <div className="button-holder">
            <Link className="btn button-regular" to="/profile/trips/hotels">
              Go to My Trips
            </Link>
          </div>
        </section>
    ...
    return (
      <div>
        <section className="details-view" id="details">
          <div className="with-padding">
            ...
            {bookingData.bookingId ? (
              <h3 className="reffernce">
                Booking Reference ID:{" "}
                <span className="refference-id">{bookingData.bookingId}</span>
              </h3>
            ) : null}
            <img
              className="details-background no-print"
              src={`${bookingData.hotelPhoto}`}
              alt="details"
            />
              ...
              <div className="check-in">
                ...
                <h5 className="check-in-content">
                  <div style={{ marginBottom: "5%" }}>
                    ...
                    {_dates.startDate.month}, {_dates.startDate.day}
                  </div>
              ...
              <div className="check-out">
                ...
                <h5 className="check-out-content">
                  <div style={{ marginBottom: "5%" }}>
                    ...
                    {_dates.endDate.month}, {_dates.endDate.day}
                  </div>
          ...
          <iframe
            className="address-map no-print"
            title="location"
            src={`https://maps.google.com/maps?q=${bookingData.latitude},${
          ...
          <div className="static-map-container">
            <img
              className="static-map-address"
              src={`https://maps.googleapis.com/maps/api/staticmap?center=${
                bookingData.latitude
              },${bookingData.longitude}&zoom=13&size=640x480&markers=${
                bookingData.latitude
              },${
                bookingData.longitude
          ...
          <div className="with-padding">
            <h4>
              <a
                className="directions button-regular no-print"
                href={`https://www.google.com/maps/dir//${
                  bookingData.hotelAddress
                }/@${bookingData.latitude},${bookingData.longitude},15z`}
                target="_blank"
            ...
            <div className="contact-info">
              ...
              <div className="contact-info-content-wrapper">
                ...
                <span className="contact-info-content-text">
          ...
          <div className="essential-info">
            ...
            <div>
              <p>
                This booking is a result of a complex distribution channel
                partnership, not of a direct contract between LockTrip and the
                hotel.
              </p>
              <p>
                We have acquired the right to book this hotel from a company
                that is authorized to redistribute its inventory. This is a
                common practice within all big OTAs, which enables us to cover
                as many properties as possible for you to choose from around the
                world.
              </p>
              <p>
                In this regard, the hotel&#39;s personnel, and more specifically
                the receptionists, should not be expected to know the exact
                end-retail website or travel agent that the booking originates
                from (
                <a
                ...
                ). They will be aware of the company authorized to redistribute
                their inventory and send the booking through.
              </p>
              <p>
                To ensure fast check-in and avoid misunderstandings, LockTrip
                provides you here with with a unique booking reference ID which
                is your undisputed proof/booking confirmation easily
                identifiable at the reception along with your name and surname.
                Alternatively, you may simply hand in the printed voucher
                (attached to this mail).
              </p>
              <p>
                NOTE: Should you want to re-confirm your stay prior to arrival,
                please make sure you wait between 6 and 24 hours before
                contacting the hotel.
              </p>
              <p>
                Information as where you made the booking, what payment method
                and/or currency you used to make the booking etc. will not help
                the receptionist retrieve your booking from the system as it is
                irrelevant.{" "}
              </p>
              <p>
                Don&#39;t hesitate to contact us if you need additional
                assistance.
              </p>
            </div>
          </div>
        ...
        <section className="details-buttons-wrapper no-print">
          ...
          <button className="btn button-regular" onClick={() => window.print()}>
            Print this page
          </button>
        </section>
      </div>
