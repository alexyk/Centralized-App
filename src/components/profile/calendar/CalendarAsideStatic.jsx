...
function CalendarAsideStatic(props) {
  return (
    <div className="col-md-4">
      ...
      <div className="col-md-12 calendar-aside-static">
        ...
        <p>Click on specific dates on the calendar to set custom rates and increase your revenue.</p>
        <div>
          <form>
            <div className="form-group">
              ...
              <div className="input-group">
                ...
                <input type="number" className="form-control" name="defaultDailyPrice" onChange={props.onChange} value={props.defaultDailyPrice} />
              </div>
            </div>
            ...
            <ReCAPTCHA
              ...
              onChange={token => props.updateDailyPrice(token)}
            />
          </form>
        </div>
      </div>
