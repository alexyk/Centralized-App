...
import { USER_NOUSER, USER_SERVERROR } from '../../../../constants/errorMessages';
          ...
          if (res.success) {
            res.body.then((data) => {
              if (data.success) {
                ...
                NotificationManager.error(USER_NOUSER + ' ' + this.state.userEmail, '', LONG);
              }
        ...
        <div className="container reservations-edit-form">
          <form onSubmit={this.eraseUserByEmail}>
            <div className="userEmail">
              ...
              <input id="userEmail" name="userEmail" value={this.state.userEmail || ''} onChange={this.onChange} type="email" required />
            </div>
            <div className="button-holder">
              <button className="btn" id="btnText" name="btnText">DELETE</button>
            </div>
          </form>
        </div>
      </div>
