...
class MobileHotelsSearchPage extends React.Component {
  constructor(props) {
    super(props);
...
MobileHotelsSearchPage.propTypes = {
...
export default withRouter(connect(mapStateToProps)(MobileHotelsSearchPage));