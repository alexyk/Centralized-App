...
class Result extends React.Component {
  ...
  render() {
    ...
    const priceInSelectedCurrency = rates && ((price * (rates[ROOMS_XML_CURRENCY][this.props.paymentInfo.currency])) / this.props.nights).toFixed(2);
      ...
      <div className="result" >
        ...
        <div className="result-content">
          ...
          <div className="result-mobile-pricing">
            ...
            {isPriceLoaded && <div className="price">For 1 night: LOC {locPrice}</div>}
            <div>
