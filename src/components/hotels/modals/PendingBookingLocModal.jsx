  ...
  return (
    <React.Fragment>
      <Modal show={props.isActive} className="modal fade myModal">
        <Modal.Header>
          <h1>Warning!</h1>
          <button type="button" className="close" onClick={(e) => props.closeModal(PENDING_BOOKING_LOC, e)}>&times;</button>
        </Modal.Header>
        <Modal.Body>
          <form onSubmit={ handleSubmit } >
            ...
            <button className="btn btn-primary" onClick={(e) => props.closeModal(PENDING_BOOKING_LOC, e)}>Cancel</button>
