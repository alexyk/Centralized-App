...
class MobileHotelBookingPage extends React.Component {
  ...
  handleSubmit() {
    if (!this.isValidNames()) {
      ...
      this.props.history.push(`/mobile/book/confirm/${id}${query}`);
...
MobileHotelBookingPage.propTypes = {
...
export default withRouter(connect(mapStateToProps)(MobileHotelBookingPage));
