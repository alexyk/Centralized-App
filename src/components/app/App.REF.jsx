...
export default class defApp extends React.Component {
  ...
  render() {
    return (
      <div data-testid="app">
      {!isMobileWebView && <MainNav />}
        {!isMobileWebView &&
          this.props.location.pathname !== "/affiliate-terms" && (
            <LocalizationNav />
          )}
        <Switch>
          <Route
            exact
            path="/recover"
            render={props => <LoginManager openRecoveryOnMount={true} />}
          />
          <Route
            render={props => <LoginManager openRecoveryOnMount={false} />}
          />
        </Switch>
        <RegisterManager />
        <WalletCreationManager />
        ...
        <Switch>
          ...
          <Route
            ...
            render={props => <AffiliateTerms />}
          />
          <Route
            exact
            path="/profile/listings/edit/:step/:id"
            render={() =>
          ...
          <Route
            exact
            path="/users/resetPassword/:confirm"
            render={() => <HomeRouterPage />}
          />
