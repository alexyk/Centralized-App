            ...
            .catch(err => {
              ...
              if (errors) {
                if (errors.hasOwnProperty("NotActiveException")) {
                  ...
                  errors.hasOwnProperty("MissingFlightReservationException")
                ) {
                  message = errors.MissingFlightReservationException.message;
                } else if (
                  errors.hasOwnProperty("MissingPassengerInfoException")
                ) {
                  ...
                  errors.hasOwnProperty("FlightProviderUnavailableException")
                ) {
